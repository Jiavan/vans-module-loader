...
module.exports = function (_chai, util) {
   ...
   *
   * Executes an expression and check expectations. Throws AssertionError for reporting if modules doesn't pass.
   *
   * @name assert
...
module.exports = function (chai, util) {
   ...
   *
   * Write your own modules expressions.
   *
   *     assert('foo' !== 'bar', 'foo is not bar');
   *     assert(Array.isArray([]), 'empty arrays are arrays');
   *
   * @param {Mixed} expression to modules for truthiness
...
/*!
 * Strict (egal) equality modules. Ensures that NaN always
 ...
 * prior to modules to ensure no bad behavior.
 *
 * @param {Arguments} a
 * @param {Arguments} b
 ...
 * #### .define (type, modules)
 *
 * Add a modules to for the `.modules()` assertion.
 *
 ...
 *
 * ```js
 * assert(lib.modules('1', 'int'));
 * assert(lib.modules('yes', 'bln'));
 * ```
 *
 * @param {Mixed} object
 * @param {String} type
...
Library.prototype.test = function (obj, type) {
  ...
  if (test && 'regexp' === getType(test)) {
    ...
    throw new ReferenceError('Type modules "' + type + '" not defined or invalid.');
  }
};
