...
function hasMillisResSync () {
  var tmpfile = path.join('millis-modules-sync' + Date.now().toString() + Math.random().toString().slice(2))
...
function hasMillisRes (callback) {
  var tmpfile = path.join('millis-modules' + Date.now().toString() + Math.random().toString().slice(2))
  tmpfile = path.join(os.tmpdir(), tmpfile)
