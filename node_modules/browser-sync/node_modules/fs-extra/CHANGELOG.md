...
<!--- move.modules fix to support CRLF on Windows -->
[#189]: https://github.com/jprichardson/node-fs-extra/pull/189
<!--- move.modules failing on windows platform -->
...
<!--- Remove modules file fixtures, create with code. -->
...
<!--- fs.copySync('/modules', '/haha') is different with 'cp -r /modules /haha' [enhancement] -->
...
<!--- Added regression modules for copy() return callback on error -->
